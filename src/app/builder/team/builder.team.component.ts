...
export class BuilderTeamComponent implements OnInit, AfterViewInit {
  ...
  openLoadModalUnits(pos, unitId) {
    this.simpleModalService.addModal(BuilderModalLoadComponent, { type: 'unit', savedItems: this.savedUnits[unitId], allowNew: true })
  ...
  showGuildDetail() {
    this.simpleModalService.addModal(BuilderModalGuildComponent, { guild : JSON.parse(JSON.stringify(this.team.guild.data)) })
  ...
  showMasterRanksDetail() {
    this.simpleModalService.addModal(BuilderModalMasterRanksComponent, { masterRanks : JSON.parse(JSON.stringify(this.team.masterRanks.data)) })
  ...
  openEquipmentsModal(unitPos, equipmentPos) {
    ...
    this.simpleModalService.addModal(BuilderModalEquipmentsComponent, { equipment: equipment, modalStep: modalStep, unit: unit, equipmentPos: equipmentPos })
  ...
  openEspersModal(pos) {
    ...
    this.simpleModalService.addModal(BuilderModalEspersComponent, { esper: esper, modalStep: modalStep, teamUnitPos: teamUnitPos })
  ...
  openCardsModal(pos, subCard = false) {
    ...
    this.simpleModalService.addModal(BuilderModalCardsComponent, { cardType: cardType, card: card, modalStep: modalStep, teamUnitPos: teamUnitPos })
  ...
  openLoadModal() {
    this.simpleModalService.addModal(BuilderModalLoadComponent, { type: 'team', savedItems: this.savedTeams })
      .subscribe(async (result) => {
  ...
  openSaveModal() {
    ...
    if (atLeasOneUnit) {
      this.simpleModalService.addModal(BuilderModalSaveComponent, { type: 'team', item: this.team })
        .subscribe((isSaved) => {
          if (isSaved) {
            this.savedTeams = this.teamService.getSavedTeams();
          }
  ...
  openLinkModal() {
    this.simpleModalService.addModal(SharedLinkModalComponent, { type: 'team', item: this.team });
  }
