...
export class BuilderUnitComponent implements OnInit, AfterViewInit {
  ...
  showGuildDetail() {
    this.simpleModalService.addModal(BuilderModalGuildComponent, { guild : JSON.parse(JSON.stringify(this.unit.guild.data)) })
  ...
  showMasterRanksDetail() {
    this.simpleModalService.addModal(BuilderModalMasterRanksComponent, { masterRanks : JSON.parse(JSON.stringify(this.unit.masterRanks.data)) })
  ...
  openEspersModal() {
    ...
    this.simpleModalService.addModal(BuilderModalEspersComponent, { esper: esper, modalStep: modalStep })
  ...
  openCardsModal(subCard = false) {
    ...
    this.simpleModalService.addModal(BuilderModalCardsComponent, { cardType: cardType, card: card, modalStep: modalStep })
  ...
  openSaveModal() {
    this.simpleModalService.addModal(BuilderModalSaveComponent, { type: 'unit', item: this.unit })
      .subscribe((isSaved) => {
        if (isSaved) {
          this.savedUnits = this.unitService.getSavedUnits();
        }
  ...
  openLinkModal() {
    this.simpleModalService.addModal(SharedLinkModalComponent, { type: 'unit', item: this.unit });
  }
